...
function matchesStatusFilter(candidate: MasterChangeCandidate, filter: GridStatusFilter): boolean {
  if (filter === 'all') {
    return true;
  }
  ...
  if (filter === 'blocked') {
    return isBlockedStatus(candidate.status);
  }
...
export function GridView({
  ...
  const [statusFilter, setStatusFilter] = useState<GridStatusFilter>('all');
  ...
  return (
    <section className="grid-view" aria-label="Vista Tabla">
      ...
      <div className="grid-toolbar">
        ...
        <label>
          <span>Cambios</span>
          <select value={statusFilter} onChange={(event) => setStatusFilter(event.target.value as GridStatusFilter)}>
            <option value="all">Todos</option>
            <option value="ready">Listos para aplicar</option>
            <option value="changed">Con cambios detectados</option>
            <option value="no_change">Sin cambios</option>
            <option value="blocked">Bloqueados o ambiguos</option>
          </select>
        </label>
      ...
      <div className="grid-action-bar">
        ...
        <div className="grid-actions">
          ...
          <button className="secondary-button" type="button" onClick={() => setStatusFilter('ready')}>
